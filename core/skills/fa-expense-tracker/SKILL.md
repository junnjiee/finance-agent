...
description: Log, edit, delete, and analyze individual expenses. Use when the user wants to add an expense, log a purchase, look at their expenses, view spending summaries, check category breakdowns, review spending trends, ask what they spent, ask how much they spent on X, show their expenses, show their spending, review purchases, or update/delete expense records. Defaults to the current month (MTD).
---
